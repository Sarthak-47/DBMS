            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b border-[rgba(255,255,255,0.07)]">
                  {['Event', 'Date', 'Regs', 'Status', 'Approval', ''].map(h => (
                  ...
                  <tr key={ev.event_id} className="border-b border-[rgba(255,255,255,0.04)] hover:bg-surface2/50 transition-colors">
                    ...
                    <td className="px-5 py-4">
                      <div className="flex items-center gap-1.5">
                        <button onClick={() => navigate(`/events/${ev.event_id}`)} title="View"
                        ...
                        {(!ev.approval_status || ev.approval_status === 'pending') && (
                          <button onClick={() => deleteEvent(ev.event_id)} disabled={deleting === ev.event_id} title="Delete"
